...
def download_dataset(
    ...
    *,
    ...
    if dataset_name not in DATASET_PATHS:
        raise ValueError(f"Unsupported LTSF dataset: {dataset_name}")
...
def main() -> int:
    """CLI entrypoint for downloading LTSF benchmark CSVs."""
    ...
    parser.add_argument(
        ...
        help="Dataset to download. Can be passed multiple times. Defaults to ETTh1.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
    ...
    dataset_names = args.dataset or ["ETTh1"]
